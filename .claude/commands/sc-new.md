...
**実績データに基づく優先度（2026-07 分析）:** 型A/D「The X Who/That〜」は型B「Why〜」より
平均CTR・平均維持率とも明確に優位（CTR 3.85% vs 2.85%、維持率 21.1% vs 17.8%、n=48本の集計）。
...
**登場人物数の上限（必須・実績データに基づく制約）:**
- エピソード全体を通して `character_ref` に設定する**人物は最大2人まで**にする
- 実績データ（2026-07分析、n=48本）: 1人構成は平均CTR 3.83%、2人構成は2.87%、
